...
_lodash2.default.extend(Sync.prototype, {
  ...
  insert: _promise2.default.method(function () {
    ...
    return this.query.insert(syncing.format(_lodash2.default.extend(Object.create(null), syncing.attributes)), '*'); // zube mod, return '*'
  }),
  ...
  update: _promise2.default.method(function (attrs) {
    ...
    return query.update(syncing.format(_lodash2.default.extend(Object.create(null), attrs)), '*'); // zube mod, return '*'
  }),
